...
class Blockchain:
    ...
    def create_genesis_block(self):
        ...
        the chain. The block has index 0, previous hash as 0, and 
        a valid hash
        """
    ...
    def add_block(self, block, proof):
        """
        A function that adds the blobk to the chain after verification. 
    ...
    def proof_of_work(self, block):
        """
        Function that tries to differentiate the values of the nonce to get a hash
    ...
    def check_chain_validity(cls, chain):
        ...
        for block in chain:
            ...
            # remove the hash field to recompute with the hash again
            # using the 'compute_hash' method
            delattr(block, "hash")
...
# a command to mine from our application itself.@app.route('/mine', methods=['GET'])
...
def register_new_peers():
    # The host addresses to the peer node
